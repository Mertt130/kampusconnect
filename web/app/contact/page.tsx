        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">destek@kampusconnect.com</p>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Ortalama 2-4 saat</p>
                    <p className="text-sm text-gray-500 mt-1">Acil durumlar için telefon</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <details className="group">
                  ...
                  <p className="mt-2 text-gray-600 text-sm">
                    Ayarlar sayfasından "Hesabı Sil" seçeneğini kullanabilirsiniz. Bu işlem geri alınamaz.
                  </p>
                </details>

                <details className="group">
                  <summary className="flex items-center justify-between cursor-pointer font-medium text-gray-900 hover:text-blue-600">
                    Şirket hesabı nasıl onaylanır?
                    <svg className="w-5 h-5 transition group-open:rotate-180" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                    </svg>
                  </summary>
                  <p className="mt-2 text-gray-600 text-sm">
                    Şirket kaydından sonra belgelerinizi yükleyin. Ekibimiz 24-48 saat içinde inceleyecektir.
                  </p>
                </details>
                ...
                <details className="group">
                  ...
                  <p className="mt-2 text-gray-600 text-sm">
                    "Başvurularım" sayfasından tüm başvurularınızın durumunu görebilirsiniz.
                  </p>
                </details>
                ...
                <details className="group">
                  ...
                  <p className="mt-2 text-gray-600 text-sm">
                    Spam klasörünüzü kontrol edin. Sorun devam ederse destek@kampusconnect.com adresine yazın.
                  </p>
                </details>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg shadow-md p-8 text-white">
              <h2 className="text-2xl font-bold mb-4">Sosyal Medyada Bizi Takip Edin</h2>
              <p className="mb-6">Güncel duyurular ve kariyer ipuçları için</p>
              <div className="flex gap-4">
                <a href="#" className="w-10 h-10 bg-white/20 hover:bg-white/30 rounded-lg flex items-center justify-center transition">
